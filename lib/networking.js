...
Networking.prototype.start = function () {
  ...
  //       this.createSocket('0', '0',
  //         '192.168.0.107', 0, this.bindToAddress.bind(this));
  //
  //     }
  //   }
  // }
  ...
  NetworkInfo.getIPAddress(ip => {
    this.createSocket('0', '0',
      ip, 0, this.bindToAddress.bind(this)); // Change to the ip of the phone
    });
  }
...
Networking.prototype.bindToAddress = function (err, interfaceIndex, networkInterface, sock) {
  ...
  sock.addListener('message', function (message, remote) {
    var packets;
  ...
  sock.addListener('error', self.onError.bind(self));
